  ...
  return (
    <div className="bg-brandColor ">
      <div className=" container mx-auto h-11 flex items-center justify-between">
        ...
        <nav className="flex gap-x-8 font-body font-semibold">
          <div className="flex flex-row">
            <a
              className=" flex items-center gap-x-2 text-white transition-all text-opacity-85 hover:text-opacity-100  "
              href="#"
            >
              <BsGlobe size={20} className="" />
              <span>Türkçe (TR)</span>
            </a>
          </div>
