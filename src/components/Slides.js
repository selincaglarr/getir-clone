...
const Slides = () => {
  ...
  return (
    <div className="h-auto sm:h-[500px] bg-purple-400 relative before:bg-gradient-to-r before:from-purple-700 before:to-transparent before:absolute before:inset-0 before:w-full before:h-full before:z-10">
      <Slider className="h-full hidden sm:block " {...settings}>
        ...
        <div>
          <div
            ...
            style={{
              backgroundImage:
                "url(https://getir.com/_next/static/images/getir-mainpage-2-7c23764275cdaf14d7b6cf15ebbdd0c1.jpg)",
            }}
          ></div>
        </div>
        <div>
          <div
            ...
            style={{
              backgroundImage:
                "url(https://getir.com/_next/static/images/getir-mainpage-3-ffd1e98c5da51809f9adcc3a4a37d751.jpg)",
            }}
          ></div>
        </div>
      </Slider>
